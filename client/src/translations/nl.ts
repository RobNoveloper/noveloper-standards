export const nl = {
  ...
  // About Section
  about: {
    title: 'Over Noveloper',
    subtitle: 'We veranderen hoe bedrijven toegang krijgen tot software-oplossingen op maat',
    origin: {
  ...
  notFound: {
    ...
    message: 'Sorry, de pagina die je zoekt bestaat niet.',
