...
export function HeroSection() {
  ...
  return (
    <section 
      id="home" 
      className="min-h-screen flex flex-col pt-20 pb-16 relative"
    >
      {/* Background gradients - positioned relative to viewport */}
      <div className="fixed top-0 right-0 -mr-10 sm:-mr-40 -mt-40 w-72 sm:w-96 h-72 sm:h-96 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 opacity-10 blur-3xl"></div>
      <div className="fixed bottom-0 left-0 -ml-10 sm:-ml-40 -mb-40 w-72 sm:w-96 h-72 sm:h-96 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 opacity-10 blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <motion.div
          ...
          className="w-full max-w-xs mx-auto mt-12 md:mt-16"
        >
          <div className="aspect-square rounded-xl shadow-xl relative overflow-hidden">
