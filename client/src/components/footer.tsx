// Vercel automatic deployment test from development branch - April 9, 2025
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-6">
              <LanguageToggle className="[&_button.text-gray-800]:text-gray-300 [&_button.bg-white]:bg-transparent [&_button.hover\:bg-gray-200]:hover:bg-gray-700" />
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-400 ml-3">
              ...
              {import.meta.env.VITE_VERCEL_ENV === 'development' && <span className="ml-2 px-2 py-0.5 bg-purple-800 text-white text-xs rounded-full">DEV</span>}
            </span>
          </div>
